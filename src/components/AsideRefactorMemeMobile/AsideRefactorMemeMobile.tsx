...
// Определение типа пропсов для компонента AsideRefactorMemeMobile
type TAsideRefactorMemeMobile = {
...
// Компонент AsideRefactorMemeMobile
const AsideRefactorMemeMobile: FC<TAsideRefactorMemeMobile> = ({
  activeButton,
  setActiveButton,
  addTextElement,
  activeModal,
  ...
  return (
    ...
    <aside className={clsx(styles.rigthSideModal, { [styles.active]: activeModal })}>
...
export default AsideRefactorMemeMobile; // Экспорт компонента AsideRefactorMemeMobile
